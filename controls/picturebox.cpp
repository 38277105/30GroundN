...
void PictureBox::setSelected()
{
    this->setWindowOpacity(0.4);
    //this->setStyleSheet("PictureBox{background:write url(image/2.png);border:2px}");
    this->setStyleSheet("PictureBox{background:black;border:2px}");
    update();
}
...
void PictureBox::mouseReleaseEvent(QMouseEvent *)
{
    mousePressed = false;
}
