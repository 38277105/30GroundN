...
//    QString("NW")
        ...
        QString::fromLocal8Bit("东北"),
        QString::fromLocal8Bit("东"),
        QString::fromLocal8Bit("东南"),
        QString::fromLocal8Bit("南"),
        QString::fromLocal8Bit("西南"),
        QString::fromLocal8Bit("西"),
        QString::fromLocal8Bit("西北")
};
...
void PrimaryFlightDisplay::updateAttitude( int component, double roll, double pitch,
...
void PrimaryFlightDisplay::speedChanged( double groundspeed, double airspeed)
{
...
void PrimaryFlightDisplay::altitudeChanged(double altitudeAMSL,
        ...
        )
        {
            ...
            if (displayTick % COMPASS_DISK_ARROWTICK == 0) {
                ...
                if (this->heading != UNKNOWN_ATTITUDE && displayTick%90 == 0) {
                    // Also draw a label
                    displayTick=displayTick%360;
                    displayTick=abs(displayTick);
