...
public:
    ...
    static void queryParam(ParamData& param,char* argName);
...
private slots:
    ...
    void rawImuMessageUpdate( mavlink_raw_imu_t rawImu);
    void scaledImu2MessageUpdate( mavlink_scaled_imu2_t scaledImu);
