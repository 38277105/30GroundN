...
private slots:
    ...
    void _cancel(void);
    bool _openBootloader(QString portName,bool isUSB);
    
private:
    //bool _findBoardFromPorts(QSerialPortInfo& portInfo, QSerialPortInfo::BoardType_t& boardType, QString& boardName);
...
public:
    ...
    void openBootloader(const QString& portName,bool isUSB);
...
signals:
    ...
    void _openBootloader(const QString& portName,bool isUSB);
    void _cancel(void);
