...
public:
    ...
    Q_INVOKABLE void flashFirmware(QString fileName,QString portName,QString baud,bool isUSB);
...
signals:
    ...
    void _openBootloader(const QString& portName);
