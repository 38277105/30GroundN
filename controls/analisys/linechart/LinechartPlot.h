...
class LinechartPlot : public ChartPlot
{
    Q_OBJECT
public:
    LinechartPlot(QWidget *parent = NULL,  quint64 interval = LinechartPlot::DEFAULT_PLOT_INTERVAL);
...
protected:
    ...
    static const quint64 MAX_STORAGE_INTERVAL = Q_UINT64_C(0);
    // The maximum interval which is stored
    // TODO CHECK THIS!!!
    int scaling;
