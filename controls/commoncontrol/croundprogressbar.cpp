#include "croundprogressbar.h"
#include <QPainter>

bool CRoundProgressBar::m_IsClosed=false;


CRoundProgressBar::CRoundProgressBar(QWidget *parent) :
    QDialog(parent)
{
...
CRoundProgressBar::~CRoundProgressBar()
{

}

void CRoundProgressBar::setScanValue(QString strValue)
{
    m_strValue = strValue;
    if(this==NULL)
        return;
...
void CRoundProgressBar::resetVariables(QPainter *painter)
...
void CRoundProgressBar::paintEvent(QPaintEvent *event)
{
    QPainter painter;
...
void CRoundProgressBar::drawOuterCircle(QPainter* painter)
...
void CRoundProgressBar::drawInnerCircle(QPainter* painter)
{
...
void CRoundProgressBar::drawColorPies(QPainter* painter, QString strValue)
{
...
void CRoundProgressBar::drawGraph(QPainter* painter)
{
...
void CRoundProgressBar::drawTextRect(QPainter* painter)
{
...
void CRoundProgressBar::mousePressEvent(QMouseEvent *event)
{
...
void CRoundProgressBar::mouseMoveEvent(QMouseEvent *event)
{
     this->move(event->globalPos() - this->dPos);
}
 void CRoundProgressBar::closeEvent()
 {
     m_IsClosed=true;
 }
