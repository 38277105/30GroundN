#ifndef _LINKINTERFACEOOO_H_
#define _LINKINTERFACEOOO_H_
...
public slots:
    ...
    virtual void appendSendMsg(mavlink_message_t message){m_sendMsgCache.push_back(message);}
public:
    QList<mavlink_message_t> m_sendMsgCache;
signals:
    void onMavLinkMessage(mavlink_message_t message);
    //void onMavLinkMessage(LinkInterface* interface,  mavlink_message_t message);
     ...
     */
    bool bytesReceived(LinkInterface* link, QByteArray data);
