...
public:
    ...
    *author: mmg
    */
    WayPointItem(internals::PointLatLng const& coord, double const& altitude, MapGraphicItem* map, const WayPointType& type, const bool& isShowNum);
    ...
    */
    ...
    void SetMoavle(const bool& isMovale);
...
public slots:
    ...
    */
    ...
    void RecieveNums(double lng, const double lat, const double alt);
signals:
    /**
